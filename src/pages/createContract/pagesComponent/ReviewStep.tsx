...
type Props = {
  ...
  clientName: string;
  clientEmail: string;
  // clientWallet not used in review view (removed)
  value: string;
  currency: string;
  deadline: string;
  ...
  return (
    <>
      ...
      <div className={styles.cardArea2}>
        <div className={styles.juraTitle} style={{paddingTop: '20px', fontFamily: 'Zen Dots', fontWeight: 100}}>Project Details</div>
        ...
        <div className={styles.juraTitle} style={{paddingTop: '20px', fontFamily: 'Zen Dots', fontWeight: 100}}>Parties</div>
        <div className={styles.reviewBox}>
