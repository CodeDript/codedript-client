...
const mockGames = [
  {
    ...
    description: 'Embark on an epic adventure in this thrilling game.',
    image: 'https://via.placeholder.com/300x200?text=Game+1',
    route: '/game/adventure-quest'
  },
  {
    id: 2,
    name: 'Puzzle Master',
  ...
  },
  {
    ...
    route: '/game/racing-thunder'
  },
  {
    id: 4,
    name: 'Strategy Empire',
    description: 'Build your empire in this strategic masterpiece.',
    image: 'https://via.placeholder.com/300x200?text=Game+4',
    route: '/game/strategy-empire'
  },
  {
    id: 5,
    name: 'Fantasy World',
    description: 'Explore magical realms in this fantasy adventure.',
    image: 'https://via.placeholder.com/300x200?text=Game+5',
    route: '/game/fantasy-world'
  }
];
