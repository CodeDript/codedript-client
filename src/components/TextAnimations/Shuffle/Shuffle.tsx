...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  // Render the text as children, not as a prop, so GSAP SplitText can split it
  return React.createElement(Tag, { ref: ref as any, className: classes, style: commonStyle }, typeof text === 'string' ? text : String(text));
};
